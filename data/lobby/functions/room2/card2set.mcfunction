...
item replace entity @e[tag=summon] armor.head from block -224 18 35 container.10
execute as @e[tag=summon] run data modify entity @s CustomName set from block -224 18 35 Items.[{Slot:10b}].tag.display.Name
execute as @e[tag=summon] run data modify entity @s Tags append from block -224 18 35 Items.[{Slot:10b}].tag.Tags.[]
