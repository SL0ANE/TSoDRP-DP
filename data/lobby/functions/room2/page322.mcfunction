...
summon minecraft:armor_stand -232 19.1 52 {CustomName:"[{\"text\":\"决一死战\",\"color\":\"white\",\"bold\":false,\"italic\":false,\"underlined\":false,\"strikethrough\":false,\"obfuscated\":false}]",Tags:["knights","10","p_card","summon","need_target","spell","s_minion","s_enemy","s_live"],Invisible:1,DisabledSlots:2039583,Rotation:[90f],Pose:{Head:[0f,0f,0f],Body:[0f,0f,0f],LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f],LeftLeg:[0f,0f,0f],RightLeg:[0f,0f,0f]},Marker:1b,CustomNameVisible:0b,ArmorItems:[{},{},{},{id:"minecraft:gray_dye",Count:1b,tag:{CustomModelData:21100}}]}
