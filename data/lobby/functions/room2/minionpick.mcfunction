...
function lobby:room2/minionpick2
...
tp @e[tag=summon2,scores={minionboard=1}] -231 19 43 -90 0
tp @e[tag=summon2,scores={minionboard=2}] -231 18 42 -90 0
tp @e[tag=summon2,scores={minionboard=3}] -231 17 41 -90 0
execute as @e[tag=summon2,scores={minionboard=1}] run item replace block -224 18 35 container.6 from entity @s armor.head
execute as @e[tag=summon2,scores={minionboard=2}] run item replace block -224 18 35 container.7 from entity @s armor.head
execute as @e[tag=summon2,scores={minionboard=3}] run item replace block -224 18 35 container.8 from entity @s armor.head
