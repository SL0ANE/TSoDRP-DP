scoreboard players set @s deck 5
clear @s lime_wool{Tags:["deck5"]}
clear @s white_wool{Tags:["deck5"]}
data modify block -9 14 -1 Items set from entity @s EnderItems.[4].tag.BlockEntityTag.Items
item replace entity @s enderchest.5 from entity @s enderchest.4
#——————————————————————————————————————————————————————————————————————————————————————————————————————
...
data modify block -9 14 -3 Items.[4].id set value "minecraft:lime_wool"
