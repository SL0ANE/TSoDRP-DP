scoreboard players set @s deck 3
clear @s lime_wool{Tags:["deck3"]}
clear @s white_wool{Tags:["deck3"]}
data modify block -9 14 -1 Items set from entity @s EnderItems.[2].tag.BlockEntityTag.Items
item replace entity @s enderchest.5 from entity @s enderchest.2
#——————————————————————————————————————————————————————————————————————————————————————————————————————
...
data modify block -9 14 -3 Items.[0].id set value "minecraft:white_wool"
...
data modify block -9 14 -3 Items.[2].id set value "minecraft:lime_wool"
