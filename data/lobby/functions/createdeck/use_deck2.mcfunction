scoreboard players set @s deck 2
clear @s lime_wool{Tags:["deck2"]}
clear @s white_wool{Tags:["deck2"]}
data modify block -9 14 -1 Items set from entity @s EnderItems.[1].tag.BlockEntityTag.Items
item replace entity @s enderchest.5 from entity @s enderchest.1
#——————————————————————————————————————————————————————————————————————————————————————————————————————
...
data modify block -9 14 -3 Items.[1].id set value "minecraft:lime_wool"
