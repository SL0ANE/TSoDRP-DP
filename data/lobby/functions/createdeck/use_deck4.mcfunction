scoreboard players set @s deck 4
clear @s lime_wool{Tags:["deck4"]}
clear @s white_wool{Tags:["deck4"]}
data modify block -9 14 -1 Items set from entity @s EnderItems.[3].tag.BlockEntityTag.Items
item replace entity @s enderchest.5 from entity @s enderchest.3
#——————————————————————————————————————————————————————————————————————————————————————————————————————
...
data modify block -9 14 -3 Items.[3].id set value "minecraft:lime_wool"
