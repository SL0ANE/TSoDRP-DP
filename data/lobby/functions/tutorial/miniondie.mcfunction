playsound minecraft:entity.blaze.death block @a[tag=tutorial] ~ ~ ~ 2 2 1
...
tag @s remove chain
tag @s remove sweep
execute at @s run function lobby:tutorial/minionhpcheck
execute at @s run function lobby:tutorial/buffcheck
