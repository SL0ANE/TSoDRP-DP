...
execute as @s[tag=check] unless entity @e[tag=8th] as @e[limit=1,tag=higher] run function lobby:rank8
execute as @s[tag=check] unless entity @e[tag=higher] run tag @s add 8th
