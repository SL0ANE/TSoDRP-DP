...
execute as @s[tag=check] unless entity @e[tag=7th] as @e[limit=1,tag=higher] run function lobby:rank7
execute as @s[tag=check] unless entity @e[tag=higher] run tag @s add 7th
