...
summon minecraft:armor_stand -174 19.1 44 {CustomName:"[{\"text\":\"结·葬\",\"color\":\"white\",\"bold\":false,\"italic\":false,\"underlined\":false,\"strikethrough\":false,\"obfuscated\":false}]",Tags:["10","potato","p_card","summon","spell","need_no_target"],Invisible:1,DisabledSlots:2039583,Rotation:[-90f],Pose:{Head:[0f,0f,0f],Body:[0f,0f,0f],LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f],LeftLeg:[0f,0f,0f],RightLeg:[0f,0f,0f]},Marker:1b,CustomNameVisible:0b,ArmorItems:[{},{},{},{id:"minecraft:gray_dye",Count:1b,tag:{CustomModelData:41100}}]}
