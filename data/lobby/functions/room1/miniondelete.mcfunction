execute as @s[scores={minionboard=1}] run item replace block -182 18 35 container.6 with air
execute as @s[scores={minionboard=2}] run item replace block -182 18 35 container.7 with air
execute as @s[scores={minionboard=3}] run item replace block -182 18 35 container.8 with air
