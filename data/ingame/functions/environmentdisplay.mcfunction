...
execute if score system arena matches 1 run data merge entity @s[scores={ownedby=1}] {Pose:{Head:[0.0f,135.0f,0.0f]}}
execute if score system arena matches 1 run tp @s[scores={ownedby=2}] 64 29 -7
execute if score system arena matches 1 run data merge entity @s[scores={ownedby=2}] {Pose:{Head:[0.0f,-45.0f,0.0f]}}