summon minecraft:marker ~ ~ ~ {CustomName:"[{\"text\":\"层数特效\",\"color\":\"white\",\"bold\":false,\"italic\":false,\"underlined\":false,\"strikethrough\":false,\"obfuscated\":false}]",Tags:["effect","stacker","summon2","summon3"],CustomNameVisible:0b,Duration:10000s}
