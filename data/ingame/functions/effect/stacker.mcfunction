...
particle dust 0.2 0.8 0.6 0.4 ~ ~ ~ 0.1 0.1 0.1 0 20 force
particle dust 0.2 0.5 0.5 0.4 ~ ~ ~ 0.1 0.1 0.1 0 20 force
execute if score @s stackcount matches 1.. as @e[tag=target,distance=..0.5] run scoreboard players operation @s stackcount += @e[tag=123] stackcount
