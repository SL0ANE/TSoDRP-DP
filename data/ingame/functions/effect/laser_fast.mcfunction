...
execute if score @s waiting matches 3.. run function ingame:effect/laser_fast2
execute if score @s waiting matches 3.. run playsound minecraft:entity.glow_squid.squirt block @a[tag=ingame] ~ ~ ~ 3 1.2 1
