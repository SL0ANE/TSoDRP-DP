...
execute at @s run particle dust 0.4 0.6 1 0.4 ~ ~ ~ 0.1 0.1 0.1 0 5 force
execute at @s run particle dust 0.9 0.9 1 0.4 ~ ~ ~ 0.1 0.1 0.1 0 5 force
execute at @s facing entity @e[tag=target,limit=1] feet run tp @s ^ ^ ^0.1
execute at @s run particle dust 0.4 0.6 1 0.4 ~ ~ ~ 0.1 0.1 0.1 0 5 force
execute at @s run particle dust 0.9 0.9 1 0.4 ~ ~ ~ 0.1 0.1 0.1 0 5 force
execute at @s facing entity @e[tag=target,limit=1] feet run tp @s ^ ^ ^0.1
...
execute at @s run particle dust 0.4 0.6 1 0.4 ~ ~ ~ 0.1 0.1 0.1 0 5 force
execute at @s run particle dust 0.9 0.9 1 0.4 ~ ~ ~ 0.1 0.1 0.1 0 5 force
execute as @e[tag=target,distance=..0.5] run function ingame:minion/stunned
execute as @e[tag=target,distance=..0.5] run scoreboard players operation @s dmgtaken += @e[tag=123] dmgtaken
execute as @e[tag=target,distance=..0.5] at @s run particle minecraft:item ice ~ ~0.7 ~ 0.2 0.2 0.2 0.1 30 force
execute if entity @e[tag=target,distance=..0.5] run playsound minecraft:entity.player.attack.crit block @a[tag=ingame] ~ ~ ~ 2 2 1
execute if entity @e[tag=target,distance=..0.5] run playsound minecraft:block.glass.break block @a[tag=ingame] ~ ~ ~ 2 1.5 1
