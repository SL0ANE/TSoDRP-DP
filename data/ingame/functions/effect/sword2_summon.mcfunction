summon minecraft:armor_stand ~ ~ ~ {CustomName:"[{\"text\":\"落剑特效\",\"color\":\"white\",\"bold\":false,\"italic\":false,\"underlined\":false,\"strikethrough\":false,\"obfuscated\":false}]",Tags:["effect","sword2","summon2","summon3"],Invisible:1,DisabledSlots:2039583,Rotation:[0f,0f],Pose:{Head:[0f,0f],Body:[0f,0f,0f],LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f],LeftLeg:[0f,0f,0f],RightLeg:[0f,0f,0f]},Marker:1b,CustomNameVisible:0b,ArmorItems:[{},{},{},{id:"minecraft:cyan_dye",Count:1b,tag:{CustomModelData:4}}]}
...
playsound minecraft:entity.tnt.primed block @a[tag=ingame] ~ ~ ~ 2 1 1
