summon minecraft:marker ~ ~ ~ {CustomName:"[{\"text\":\"圣光特效\",\"color\":\"white\",\"bold\":false,\"italic\":false,\"underlined\":false,\"strikethrough\":false,\"obfuscated\":false}]",Tags:["effect","light_buff","summon2","summon3"],CustomNameVisible:0b,Duration:10000s}
