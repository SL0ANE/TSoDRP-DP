summon minecraft:marker ~ ~0.3 ~ {CustomName:"[{\"text\":\"消灭特效\",\"color\":\"white\",\"bold\":false,\"italic\":false,\"underlined\":false,\"strikethrough\":false,\"obfuscated\":false}]",Tags:["effect","kill","summon2","summon3"],CustomNameVisible:0b,Duration:10000s}
