summon minecraft:marker ~ ~ ~ {CustomName:"[{\"text\":\"治疗特效\",\"color\":\"white\",\"bold\":false,\"italic\":false,\"underlined\":false,\"strikethrough\":false,\"obfuscated\":false}]",Tags:["effect","healer","summon2","summon3"],CustomNameVisible:0b,Duration:10000s}
