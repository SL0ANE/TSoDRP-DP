tag @s add running1
execute as @e[tag=environmentcaster,scores={environmentlife=1..}] if score @s ownedby = @e[tag=running1,limit=1] ownedby run tag @s add environment1
execute as @e[tag=card,scores={handorder=1..}] if score @s ownedby = @e[tag=running1,limit=1] ownedby run tag @s add counts
...
tellraw @a[tag=click] [{"text":"       ","color":"green","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false},{"text":"手牌数：","color":"white","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false},{"score":{"objective":"handcardcount","name":"@s"},"color":"white","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false},{"text":"/","color":"white","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false},{"score":{"objective":"handcardlimit","name":"@s"},"color":"white","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]
