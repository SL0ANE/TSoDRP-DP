...
execute if score @s cardcasting2 matches 18 unless entity @e[tag=pass] as @e[tag=mascot,scores={roundending=1..}] if score @s ownedby = @e[tag=123,limit=1] ownedby run tag @s add pass
