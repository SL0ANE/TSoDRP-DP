...
execute if score @s hasbuff matches 0 run execute as @e[tag=buffstorage] if score @s minioncode = @e[tag=checking,limit=1] minioncode run tag @s add cancelled
execute if score @s hasbuff matches 1.. run execute as @e[tag=buffstorage] if score @s minioncode = @e[tag=checking,limit=1] minioncode run tag @s add mark
execute as @e[tag=buffstorage] if score @s minioncode = @e[tag=dyingrun,limit=1] minioncode run tag @s add skulllogo
execute as @e[tag=buffstorage] if score @s minioncode = @e[tag=dyingrun2,limit=1] minioncode run tag @s add skulllogo
