...
execute if entity @s[tag=addaggressive,tag=!aggressive] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=addimmune,tag=!immune] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=addtough,tag=!tough] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=addkeen,tag=!keen] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=addprudent,tag=!prudent] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=addstrike,tag=!strike] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=addcunning,tag=!cunning] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=adddodge,tag=!dodge] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=addpuzzle,tag=!puzzle] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=addblock,tag=!block] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=addchain,tag=!chain] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
execute if entity @s[tag=addsweep,tag=!sweep] run playsound minecraft:ui.loom.take_result block @a[tag=ingame] ~ ~ ~ 3 1 1
...
execute if entity @s[tag=addaggressive] run function ingame:minion/buffcheck
execute if entity @s[tag=addimmune] run function ingame:minion/buffcheck
execute if entity @s[tag=addtough] run function ingame:minion/buffcheck
execute if entity @s[tag=addkeen] run function ingame:minion/buffcheck
execute if entity @s[tag=addprudent] run function ingame:minion/buffcheck
execute if entity @s[tag=addstrike] run function ingame:minion/buffcheck
execute if entity @s[tag=addcunning] run function ingame:minion/buffcheck
execute if entity @s[tag=adddodge] run function ingame:minion/buffcheck
execute if entity @s[tag=addpuzzle] run function ingame:minion/buffcheck
execute if entity @s[tag=addblock] run function ingame:minion/buffcheck
execute if entity @s[tag=addchain] run function ingame:minion/buffcheck
execute if entity @s[tag=addsweep] run function ingame:minion/buffcheck
execute if entity @s[tag=aggressive,scores={aggressivetime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=immune,scores={immunetime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=tough,scores={toughtime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=keen,scores={keentime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=prudent,scores={prudenttime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=strike,scores={striketime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=cunning,scores={cunningtime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=dodge,scores={dodgetime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=puzzle,scores={puzzletime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=block,scores={blocktime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=chain,scores={chaintime=0}] run function ingame:minion/buffcheck
execute if entity @s[tag=sweep,scores={sweeptime=0}] run function ingame:minion/buffcheck

execute if entity @s[tag=dmgimmune,scores={dmgimmunetime=0}] run function ingame:minion/buffcheck

execute if entity @s[tag=addstun] run function ingame:minion/stunned
